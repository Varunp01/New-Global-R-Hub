            ...
            <div className="w-full my-14">
                <div className="WeAchived flex justify-center items-center">
                    <div className="">
                        ...
                        <div className="fontInter md:px-40 text-center px-5 font-medium text-[#818181] text-base py-2">Receive global expert mentorship from leading international faculty and PhD fellows to turn your academic interests into impactful, publishable research projects!</div>
                    </div>
                </div>
            </div>
        </>
