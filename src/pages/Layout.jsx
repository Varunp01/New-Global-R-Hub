                ...
                {(!ShowNav)
                    ? <>
                        <div className="navbtns md:w-2/3  sm:hidden sm:items-center justify-center text-center md:justify-normal">
                            <div className="navbtn1 px-5 py-3 text-[#68696F] text-base font-medium" onClick={() => setShowNav(true)}><span className="p-2 hover:bg-[#F93800]/20 rounded-md">Tap to see more pages</span></div>
                        </div>
                    </>
                    : <>
                        <div className="navbtns md:w-2/3  sm:hidden sm:items-center justify-center text-center md:justify-normal">
